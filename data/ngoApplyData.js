...
export default {
  ...
  faq: [
    {
      ...
      answer: (
        <>
          ...
          functional prototype is completed after one semester. However, these
          projects continue by gathering feedback during the next semester and
          iterating on the prototype to ensure that we're creating the most
  ...
  applicationDetail: (
    <>
      ...
      As long as you fill out an application,{" "}
      {/*before <b>{applicationDueDate}</b>*/}
